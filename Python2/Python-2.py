...
# </center>
# 
# * Download the zipped data availalble [here](https://github.com/triangle-digital-humanities-institute/Python/raw/master/Python2/Python_Sales/Python_Sales.zip). Unzip them somewhere on your computer.
# 
...
# * (Mac) Finder > Applications > Anaconda Navigator > Environments Tab > (play button listed next to "root") > Open Terminal
# 
# Download [file_explore.py](https://github.com/triangle-digital-humanities-institute/Python/raw/master/Python2/file_explore.py)
# 
...
# 
# Download the csv file <a href="https://raw.githubusercontent.com/triangle-digital-humanities-institute/Python/master/Python2/CountyHealthData_2014-2015.csv"> 
